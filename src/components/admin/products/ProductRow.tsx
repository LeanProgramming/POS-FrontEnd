...
export const ProductRow = ({ product, onDelete, onEdit }: IProductRowProps) => {
	const stockStatus =
		product.stock === 0
	...
	return (
		<div className='grid grid-cols-[2fr_1fr_1fr_1fr_80px] gap-3 px-4 py-3 items-center hover:bg-[#161616] transition-colors group'>
			{/* Nombre + SKU */}
			<div>
